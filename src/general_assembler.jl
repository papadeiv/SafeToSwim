...
include("./general_flow_assembler.jl")
include("./general_rainfall_assembler.jl")

function general_assembler(SiteName,FlowSiteName,RainfallSiteName)
        # Generate the flow and rainfall lagged observation matrices
        general_flow_assembler(SiteName,FlowSiteName)
        general_rainfall_assembler(SiteName,RainfallSiteName)
        ...
        @showprogress for n in 2:7
                ...
                filename = "observations_generalised/flow_max/$n.csv"
                ...
                filename = "observations_generalised/rainfall/$n.csv"
                df = CSV.read("../data/"*filename, DataFrame)
